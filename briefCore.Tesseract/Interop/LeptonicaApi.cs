namespace briefCore.Tesseract.Interop
{
    ...
    public interface ILeptonicaApiSignatures
    {
        ...
        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixGetBinnedComponentRange")]
        int pixGetBinnedComponentRange(HandleRef cmap, int component, out int minVal, out int maxVal);

        [RuntimeDllImport(Constants.LeptonicaDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "pixGetExtremeValue")]
        int pixGetExtremeValue(HandleRef cmap, int type, out int rVal, out int gVal, out int bVal);
