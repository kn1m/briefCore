namespace briefCore.Tesseract
{
    ...
    public sealed class PixColormap : IDisposable
    {
        ...
        public int Depth
        {
            get { return LeptonicaApi.Native.pixcmapGetDepth(handle); }
        }

        public int Count
        {
            get { return LeptonicaApi.Native.pixcmapGetCount(handle); }
        }

        public int FreeCount
        {
            get { return LeptonicaApi.Native.pixcmapGetFreeCount(handle); }
        }
